...
describe("Alert.vue", () => {
  ...
  it("should render the alert with default props", () => {
    ...
    // close icon
    const iconElement = wrapper.findComponent(SjIcon);
  ...
  it("should emit close event when close icon is clicked", () => {
    ...
    wrapper.findComponent(SjIcon).trigger("click");
  ...
  it("should support centering text", () => {
    ...
    //class
    const rootNode = wrapper.find(".sj-alert");
  ...
  it("should not render close icon when closable is false", () => {
    ...
    expect(wrapper.find(".sj-alert__close").exists()).toBe(false);
  });
  ...
  it("should toggle visibility when open and close methods are called", async () => {
    ...
    expect(wrapper.find(".sj-alert").attributes().style).toBe("display: none;");
    await wrapper.vm.open();
    expect(wrapper.find(".sj-alert").attributes().style).toBe("");
  });
});
