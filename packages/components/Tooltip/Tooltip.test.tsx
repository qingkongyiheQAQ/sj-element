...
describe("Tooltip.vue", () => {
  ...
  test("basic tooltip", async () => {
    ...
    expect(wrapper.get(".sj-tooltip__popper").text()).toBe("hello tooltip");
  ...
  test("tooltip with hover trigger", async () => {
    ...
    expect(wrapper.find(".sj-tooltip__popper").exists()).toBeTruthy();
    // 测试悬外隐藏
    wrapper.find(".sj-tooltip").trigger("mouseleave");
    await vi.runAllTimers();
    expect(wrapper.find(".sj-tooltip__popper").exists()).toBeFalsy();
  });
