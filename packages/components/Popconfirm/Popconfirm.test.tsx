...
describe("Popconfirm/index.ts", () => {
  ...
  it("should be exported with withInstall()", () => {
    expect(SjPopconfirm.install).toBeDefined();
  });

  // 测试 Popconfirm 组件是否被正确导出
  it("should be exported Popconfirm component", () => {
    expect(SjPopconfirm).toBe(PopConfirm);
  });
  ...
  test("should enhance Popconfirm component", () => {
    ...
    expect(enhancedPopconfirm).toBe(SjPopconfirm);
...
describe("Popconfirm.vue", () => {
  ...
  test("popconfirm emits", async () => {
    ...
    expect(wrapper.find(".sj-popconfirm").exists()).toBeTruthy();
    const confirmBtn = wrapper.find(".sj-popconfirm__confirm");
    expect(confirmBtn.exists()).toBeTruthy()

    confirmBtn.trigger("click");
    await vi.runAllTimers();
    expect(wrapper.find(".sj-popconfirm").exists()).toBeFalsy();
    ...
    const cancelBtn = wrapper.find(".sj-popconfirm__cancel");
