...
import { type CollapseItemName } from "sj-element";
import { ref } from "vue";
...
<template>
  <sj-collapse v-model="activeNames" @change="handleChange">
    ...
    <sj-collapse-item title="Feedback" name="2">
      <div>
    ...
    <sj-collapse-item title="Efficiency" name="3">
      <div>
